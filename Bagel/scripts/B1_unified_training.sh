...
if [[ "$RUN_MODE" == "train" ]]; then
  ...
  echo "[B1]   PolicyTok:  max_completion_tokens=$POLICY_MAX_COMPLETION_TOKENS text_only=$POLICY_TEXT_ONLY_MAX_COMPLETION_TOKENS"
  echo "[B1]   PolicyFB:   text_only_fallback=$POLICY_TEXT_ONLY_FALLBACK"
